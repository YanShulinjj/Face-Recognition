# -*- coding: utf-8 -*-
"""
Created on Fri Jun  5 00:23:37 2020
...
class Facenet():
    ...
    def __init__(self):
        ...
        self.facenet = load_model('data/facenet_keras.h5')
...
#        data = (data - mean) / std
        ...
        vec = self.facenet.predict(X_train)
    ...
    def init(self):
        ...
        joblib.dump((self.mode_v, self.labels, self.test_imgs, self.test_tags), open('data/facenet_mode_data.pkl', 'wb'))
        print('Successfully')
    def load(self):
        print('Loading the mode...')
        self.mode_v, self.labels, self.test_imgs, self.test_tags =joblib.load(open('data/facenet_mode_data.pkl', 'rb'))
        print('Successfully')
